...
export default class MesOffres extends React.Component {
	...
	render() {
		...
		if (this.state.OfferType === "history") {
			...
			for (let i = 0; i < this.state.Datas.length; i++) {
				if (this.state.Datas[i].adress[0]) {
					MyDatas.push(
						<OfferLabel
							key={this.state.Datas[i]._id}
							id={this.state.Datas[i]._id}
							...
							picture={this.state.Datas[i].picture}
							companyName={
								this.state.Datas[i].company.companyAccount.companyName
							}
							logoCompany={
								this.state.Datas[i].company.companyAccount.companyLogo[0]
							}
							navigation={this.props.navigation}
							address={
								this.state.Datas[i].adress[0].streetNumber +
								" " +
								this.state.Datas[i].adress[0].streetName +
								", " +
								this.state.Datas[i].adress[0].city
							}
						/>
					);
				} else {
